...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>拖動 &amp; 刪除文件</b></span>",
            uploadStr: "上傳",
            abortStr: "終止",
            cancelStr: "取消",
            deleteStr: "刪除",
            doneStr: "完成",
            multiDragErrorStr: "多個檔案拖動 &amp; 刪除 不被允許。",
            extErrorStr: "不被允許。允許的擴展名：",
            duplicateErrorStr: "此文件不被允許上傳。文件已存在。",
            sizeErrorStr: "此文件不被允許上傳。允許的檔案最大大小： ",
            uploadErrorStr: "不被允許上傳",
            maxFileCountErrorStr: "不被允許。允許的最大文件為：",
            downloadStr: "下載",
            customErrorKeyStr: "jQuery的上傳文件錯誤",
            showQueueDiv: false,
            statusBarWidth: 400,
            dragdropWidth: 400,
            showPreview: false,
