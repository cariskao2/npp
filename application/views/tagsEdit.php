        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary not-list-L-scroll">
                    <!-- form start -->
                    <form role="form" action="<?php echo base_url() ?>news/tagsEditSend" method="post" id="addYearSend"
                        role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="tagsid"
                                            value="<?php echo $getTagsEditInfo->tags_id; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div id="radioBtn" class="btn-group">
                                                <?php
$active    = $getTagsEditInfo->showup == 1 ? 'active' : 'notActive';
$notActive = $getTagsEditInfo->showup == 0 ? 'active' : 'notActive';
?>
