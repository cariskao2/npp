				...
				<div class="box box-primary" style="border:none;">
					<div class="add-edit-scroll">
						<div class="box-body">
							<div id="sortlist">
								<?php
if (!empty($billCategoryListing)) {
    foreach ($billCategoryListing as $record) {
        ?>
								<div class="ui-state-default" dbid="<?php echo $record->gory_id; ?>">
...
<script language='javascript' type='text/javascript'>
	$(function () {
		...
		$("#save").click(function () {
			var _sort = new Array();
			var hitURL = baseURL + 'bills/billCategorySortSend';
			...
			$.ajax({
				...
				success: function (data) {
					...
					window.location.href = baseURL + 'bills/billCategorySort';
				},
