			...
			<div class="col-md-12">
				...
				<div class="box box-primary" style="border:none;">
					<div class="add-edit-scroll">
						<!-- form start -->
						<form role="form"
							action="<?php echo base_url('bills/billCaseSessionAdd/' . $getBillCaseInfo->case_id); ?>"
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select style="padding-top:0;padding-bottom:0" class="form-control" id=""
												...
												<?php
if (!empty($getBillCaseSession)) {
    foreach ($getBillCaseSession as $item) {
        ?>
...
?>
											...
											<?php echo form_error('sessions'); ?>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="date" class="must">日期</label>
